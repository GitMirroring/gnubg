 ...
 * Copyright (C) 2005-2025 the AUTHORS
 *
...
CreateMessageWindow(void)
{
    ...
    gtk_text_view_set_left_margin(GTK_TEXT_VIEW(pwMessageText), 6);
    gtk_text_view_set_right_margin(GTK_TEXT_VIEW(pwMessageText), 6);
